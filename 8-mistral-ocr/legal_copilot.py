...
def ocr_pdf():
    uploaded_pdf = client.files.upload(
        file={
            ...
            "content": open("8-mistral-ocr/pdf/light-duty-vehicules.pdf", "rb"),
        },
        purpose="ocr"
    )
    ...
    with open("ocr_response.md", "w", encoding="cp1252", errors="ignore") as f:
...
def main():
    ...
    with open('ocr_response.md', 'r', encoding='utf-8', errors='ignore') as f:
        text = f.read()
