...
class ResearchAnalystWorkflow(Workflow):
    ...
    def run(self, ocr_text: str, user_country: str) -> Iterator[RunOutput]:
        analysis_response: Iterator[RunOutput] = self.structure_and_analysis_agent.run(ocr_text)
...
if __name__ == "__main__":
    ...
    if submitted and pdf_path and user_country:
        ...
        with st.spinner("Running research workflow..."):
            ...
            response: Iterator[RunOutput] = workflow.run(ocr_text=ocr_text, user_country=user_country)
