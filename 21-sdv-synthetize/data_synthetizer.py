...
# Load the data
real_data = pd.read_csv('21-sdv-synthetize/Data/E-Commerce Dataset.csv', nrows=500)
...
def synthetize_data():
    ...
    synthetic_data.to_csv('21-sdv-synthetize/Data/synthetic_data.csv', index=False)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if user_input == 'help':
            ...
            synthetize_data()
            print("Data synthetized successfully, view file '21-sdv-synthetize/Data/synthetic_data.csv'")
            print("""
