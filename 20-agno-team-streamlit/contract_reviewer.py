...
if st.button("Review Contract"):
    ...
    with st.spinner("Analyzing..."):
        for event in manager_agent.run(
            input="Please analyze this contract by providing legal context, evaluating its structure, and identifying negotiable terms. Combine the insights into a single summary.",
            stream=True,
        ):
