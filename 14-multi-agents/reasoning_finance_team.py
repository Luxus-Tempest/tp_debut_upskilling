...
reasoning_finance_team.print_response(
    "Analyse complète de Tesla (TSLA) : Effectue une recherche web sur les dernières actualités et tendances du marché pour Tesla, puis récupère les données financières actuelles (cours, ratios P/E, capitalisation, revenus). Combine ces informations pour fournir une analyse fondamentale détaillée avec recommandation d'investissement. Présente les résultats sous forme de tableaux structurés avec sources et justifications."
)
...
"""
    ...
    3. Compare risk vs return to jmarket benchmarks
