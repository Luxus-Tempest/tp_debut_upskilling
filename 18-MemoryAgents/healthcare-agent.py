...
import asyncio
runner = Runner(agent=root_agent, app_name="healthcare_app", session_service=InMemorySessionService())

async def main():
    prompt = "Bonjour, j'ai des allergies aux noix et je veux les enregistrer."
