...
class OffensiveCybersecurityTester(Workflow):
    ...
    def run(self, domain: str) -> Iterator[RunOutput]:
        ...
        recon_response: Iterator[RunOutput] = self.recon_agent.run(full_context)
...
if __name__ == '__main__':
    ...
    response: Iterator[RunOutput] = workflow.run(domain=domain)
